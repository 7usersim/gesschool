...
@section("title",__("List Cycle"))
@section("title_content",__("List Cycles"))
@section('css')
  <!-- DataTables -->
...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            <h4 class="text-white">{{__(" Cyles list")}}</h4>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary ">
          <h5 class="modal-title text-white">Cycle</h5>
        ...
        <div class="modal-body">
            <form method="POST" id="idFormROle" name="formRole" novalidate class="needs-validation">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" required class="form-control" id="name" placeholder="{{__('Enter cycle name')}}">
                </div>

                <div class="form-group">

                  <label for="code">{{__("Code ")}}</label>
                  <input type="text" name="code" required class="form-control" id="code" aria-describedby="emailHelp" placeholder="{{__('Enter cycle code')}}">

                </div>
                <div class="form-group">
                  <label for="description">Description</label>
                  <input type="text" name="description" required class="form-control" id="description" placeholder="{{__('Enter description')}}">
                </div>
            ...
            $('.save').on('click', function(e){
                ...
                if(form.checkValidity() === false){
                   ...
                   form.classList.add('was-validated');
                    ...
                    Swal.fire({
                        title:' Enregistrement cycle',
                        text: ' Do you want to save this cycle?',
                        icon: 'info',
